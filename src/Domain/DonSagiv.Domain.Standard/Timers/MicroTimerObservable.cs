...
namespace DonSagiv.Domain.Standard.Timers;
public class MicroTimerObservable(long intervalMicroSeconds) : ObservableBase<long>
{
    ...
    {
        var periodMilliseconds = Convert.ToInt64(timeSpanInput.TotalMilliseconds);

        return new MicroTimerObservable(periodMilliseconds);
    }
    #endregion
