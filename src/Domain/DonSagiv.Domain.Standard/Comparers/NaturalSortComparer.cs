...
namespace DonSagiv.Domain.Standard.Comparers;

/// <summary>
/// Obtained from user tompazourek on Github.
...
public class NaturalSortComparer : IComparer<string>
{
    ...
    public static NaturalSortComparer Create(StringComparison stringComparison = StringComparison.OrdinalIgnoreCase)
    {
